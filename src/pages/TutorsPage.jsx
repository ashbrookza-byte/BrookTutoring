...
const TUTORS = [
  {
    ...
    grades: 'Grades 10 – 12',
    bio: 'Mitchell is the founder of Brook Tutoring. He specialises in maths tutoring, offering both one-on-one and group sessions. His goal is to make learning clear, helping students build confidence and succeed in a supportive environment.',
    color: '#22c55e',
  },
  {
    name: 'Anna Jacobs',
  ...
  },
  {
    ...
    subjects: ['Accounting'],
    grades: 'Grades 6 – 12',
    bio: 'Rea is a highly qualified accountant who made a career change to pursue his passion for teaching. With extensive knowledge and hands-on experience in accounting, he brings a wealth of real-world expertise to every session.',
    color: '#14b8a6',
  },
  {
    name: 'Jess Donachie',
    photo: '/tutors/jess.jpg',
    role: 'Primary & Languages Tutor',
    subjects: ['Mathematics', 'English', 'History', 'Drama', 'Business'],
    grades: 'Grades 1 – 12',
    bio: 'Driven by her passion for working with children, Jess helps young learners thrive across all subjects, fostering confidence and a love for learning in every student she teaches.',
    color: '#f59e0b',
  },
  {
    name: 'Shani Roodt',
    ...
    grades: 'Grades 6 – 12',
    bio: 'Shani is a talented tutor in Maths, Afrikaans, and English. Her gentle approach fosters a nurturing environment where students thrive. With dedication and a personal connection, she guides learners through complex equations and language mastery.',
    color: '#ec4899',
  },
]
...
const SUBJECT_COLORS = {
  ...
  'History':     { bg: 'rgba(168,85,247,0.1)',  color: '#9333ea' },
  'Drama':       { bg: 'rgba(236,72,153,0.1)',  color: '#db2777' },
  'Business':    { bg: 'rgba(59,130,246,0.1)',  color: '#2563eb' },
}
